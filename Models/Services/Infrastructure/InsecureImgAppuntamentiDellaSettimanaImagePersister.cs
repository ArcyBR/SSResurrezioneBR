...
{
    public class InsecureImgAppuntamentiDellaSettimanaImagePersister : IImgPersister
    {
        const int ERROR_SHARING_VIOLATION = 32;
        const int ERROR_LOCK_VIOLATION = 33;

        private readonly IWebHostEnvironment environment;
        public InsecureImgAppuntamentiDellaSettimanaImagePersister(IWebHostEnvironment environment)
        {
