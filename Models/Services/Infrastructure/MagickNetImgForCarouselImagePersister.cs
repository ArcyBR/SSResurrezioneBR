...
{
    public class MagickNetImgForCarouselImagePersister : IImgPersister
    {
        ...
        public MagickNetImgForCarouselImagePersister(IWebHostEnvironment environment, IConfiguration configuration)
        {
        ...
        public async Task<string> SaveImageAsync (IFormFile formFile)
        {
            ...
            try{
                if (fileName==valid){
                    ...
                    int width = _configuration.GetValue<int>("ImgForCarouselImage:width");
                    int height = _configuration.GetValue<int>("ImgForCarouselImage:height");
